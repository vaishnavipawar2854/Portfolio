...
export default function Achievements() {
  ...
  return (
    <section id="achievements" className="py-16 md:py-24 px-6 md:px-12 lg:px-20 scroll-mt-20">
        ...
        >
          ...
          >
            <GlassCard className="p-6 h-full">
              <h3 className="text-accent-primary font-semibold text-base mb-4 flex items-center gap-2">
